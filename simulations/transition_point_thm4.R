...
cols_re = which(sigma2_star!=0)
sigma2_bar = tau_r_range(edat_train, edat_test, rep(1/ndat, ndat), sigma_eps, 
...
### run simulations
scale.vals.2 = seq(nvar*sigma2_bar[1]/sum(sigma2_star), nvar*sigma2_bar[2]/sum(sigma2_star), length=5)
...
save(err, results, scale.vals, sigma2_star, sigma2_bar, 
     ...
     file=paste0("thm3_thm4_RData/transition_point_thm4_", ind[1], "_", ind[length(ind)], ".RData"))
