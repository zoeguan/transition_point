...
names(r1) = c("LME", "LME2", "LS,M", "LS,C", "L,M", "L,C", "R,M", "R,C", "RF,M", "RF,C", "NN,M", "NN,C", "MA2", "MA")
...
names(r2) = c("LME", "LME2", "LS,M", "LS,C", "L,M", "L,C", "R,M", "R,C", "RF,M", "RF,C", "NN,M", "NN,C", "MA2", "MA")
...
names(r3) = c("LME", "LME2", "LS,M", "LS,C", "L,M", "L,C", "R,M", "R,C", "RF,M", "RF,C", "NN,M", "NN,C", "MA2", "MA")
...
g2.title <- paste0("=", round(sigma.vals[5], 2), " (OLS transition point)")
g2 <- ggplot(melted2, aes(x = Model, y = log.MSPE)) +
  geom_boxplot() + ggtitle(bquote(paste(bar(sigma^2)) ~ .(g2.title))) +
  ylab(expression( paste("log", bgroup("(", frac( "MSPE"["Model"], "MSPE"["LME"]), ")" ) )))
g2

g3.title <- paste0("=", round(sigma.vals[13], 2), " (OLS transition point)")
